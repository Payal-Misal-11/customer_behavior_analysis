...
I handled the analytic pipeline end-to-end:
...
- Loaded final DataFrame into **PostgreSQL** for advanced SQL analysis
...
- Introduce **subscriber-only** rewards → convert heavy buyers to members  
- Promote **top-rated items** in marketing (high ROI products)  
- Optimize discount policy (reduce over-discounting strong sellers)  
- Target **young adults + express shipping users** for premium offerings  
